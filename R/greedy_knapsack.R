...
#'
#' @param x A data frame with two numeric variables v and w (the maximum knapsack value and the positions of the elements).
#' @param W Numeric variable of knapsack size.
#'
#' @return A list printing out item position and their total value
#' @export
#'
#' @examples
#' set.seed(42)
